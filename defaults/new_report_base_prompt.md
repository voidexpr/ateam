<!-- TODO: fix this before v1 — merge with defaults/report_base_prompt.md once new role set is validated; this duplicate base exists only for A/B comparison between legacy and dotted-prefix roles. -->
