...
func TestResolveStreamPath(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			projectDir: "/home/user/myproject/.ateam",
			orgDir:     "/home/user/.ateamorg",
			sf:         "/var/log/agent.jsonl",
			want:       "/var/log/agent.jsonl",
		},
		{
			name:       "legacy projects/ prefix resolves to orgDir",
			projectDir: "/home/user/myproject/.ateam",
			orgDir:     "/home/user/.ateamorg",
			sf:         "projects/myproject/roles/security/logs/agent.jsonl",
			want:       filepath.Join("/home/user/.ateamorg", "projects/myproject/roles/security/logs/agent.jsonl"),
		},
		{
		...
		},
		{
			...
			orgDir:     "",
			sf:         "projects/myproject/roles/security/logs/agent.jsonl",
			want:       filepath.Join("/home/user/myproject/.ateam", "projects/myproject/roles/security/logs/agent.jsonl"),
		},
		{
			...
			orgDir:     "/home/user/.ateamorg",
			sf:         "logs/agent.jsonl",
			want:       filepath.Join("/home/user/.ateamorg", "logs/agent.jsonl"),
		},
		{
