...
- **Commands**: print every ateam CLI command before running it
  ...
  Running: ateam prompt --agent security --action code --extra-prompt @.ateam/supervisor/code/2026-03-08_14-05-30/current_task.md
  Running: ateam run @.ateam/supervisor/code/2026-03-08_14-05-30/01_fix_sql_injection_code_prompt.md --agent security
  ```
